...
syn keyword maudeMsg        cmsg msg from to if
syn keyword maudeModule     mod fmod omod endm endfm endom is th endth fth endfth oth endoth
syn keyword maudeImports    protecting including extending
syn keyword maudeSorts      sorts sort subsorts msg class
syn keyword maudeStatements op ops var vars eq ceq rl crl
syn match   maudeFlags      "\[.*\]"
syn keyword maudeCommands   red reduce search rew rewrite set
...
syn keyword maudeAttrs      prec gather format ctor config object frozen
