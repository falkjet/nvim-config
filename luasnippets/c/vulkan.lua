...
return {
  s({ trig = 'vst', name = "Vulkan structure" }, fmta([[
    Vk<> <>
  ]], {
    i(1),
    d(2, function(args)
      return sn(nil, fmta([[
        ...
        f(copy, 1),
        f(function(args)
          return 'VK_STRUCTURE_TYPE_' .. to_upper_snake(args[1][1])
        end, 1),
      }))
    end, 1)
  })),
  s({ trig = 'vmk', name="Create vulkan object" }, fmta([[
    Vk<1>CreateInfo <2>;
    <3>.sType = <4>;
    <3>.pNext = NULL;
    <5>
    ...
    f(copy, 2),
    f(function(args)
      return 'VK_STRUCTURE_TYPE' .. to_upper_snake(args[1][1]) .. '_CREATE_INFO'
    end, 1),
    d(3, function(args)
      return sn(nil, fmta([[
        Vk<1> <2>;
  ...
  s({ trig = 'appinfo', name = "Vulkan appinfo struct" }, fmta([[
    VkApplicationInfo <1>;
    <2>.pNext = NULL;
  ...
  s({ trig = 'mkinstance', "Create a vulkan instance" }, fmta([[
